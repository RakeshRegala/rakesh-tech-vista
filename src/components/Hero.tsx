  ...
  return <section id="home" className="relative min-h-screen flex items-center section-padding overflow-hidden">
      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
          <div className="lg:col-span-3 space-y-6 animate-fade-in" style={{
          animationDelay: '0.2s'
        }}>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">Passionate about full-stack web development, data science, and backend technologies. Aspiring to contribute to top tech companies creating innovative solutions to real-world problems.</p>
          ...
          <div className="lg:col-span-2 flex justify-center lg:justify-end animate-fade-in" style={{
          animationDelay: '0.4s'
        }}>
            <div className="relative">
              ...
              <div className="w-64 h-64 md:w-80 md:h-80 rounded-full overflow-hidden border-4 border-background relative">
                ...
                <img src="/placeholder.svg" alt="Regala Rakesh" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
